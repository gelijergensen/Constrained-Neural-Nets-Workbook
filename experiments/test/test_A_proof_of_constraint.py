...
def test_proof_of_constraint():
    ...
    final_result = run_experiment(
        num_epochs, save_directory=directory, save_file=save_file,
        num_points=100, num_training=10, batch_size=10)
    ...
    try:
        ...
        assert(type(loaded_config.pop('model_act')) ==
               type(final_config.pop('model_act')))
