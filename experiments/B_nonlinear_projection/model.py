"""Two different models to investigate"""

import numpy as np
import torch
import torch.nn as nn

from src.projection import ProjectableModel
...
# TODO finish this
class SpectralDense(ProjectableModel):
    """A model which using spectral methods (Fast Fourier Transform) to 
    produce a representation of a function"""
