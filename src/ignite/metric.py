...
change: torch.no_grad() is NOT called as a decorator of the iteration_completed
method"""
...
class GradientMetric(with_metaclass(ABCMeta, object)):
    """
    ...
    # @torch.no_grad() # We need the gradient, so we can't disable it here
    ...
    def __add__(self, other):
        from src.ignite.metric_lambda import GradientMetricsLambda
